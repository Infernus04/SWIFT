...
let favoriteBook = Book(title: "Art of War", author: "Sun Tzu", pages: 222, price: 12)
print("The title is \(favoriteBook.title) , author : \(favoriteBook.author), pages : \(favoriteBook.pages), price : \(favoriteBook.price)")
/*:
...
let ss = Laptop(yearPurchased: 2023)
let rc = Laptop(yearPurchased : 2020)
print(ss.screenSize,rc.repairCount)
/*:
...
struct Height{
    ...
    init(HeightInCentimeter : Double){
        self.HeightInCentimeters = HeightInCentimeter
        HeightInInches = HeightInCentimeter / 2.54
    }
}
