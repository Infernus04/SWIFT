 ...
 */
func stepsCOunt() {
    progressBySteps(steps: 1000, goal: 10000)
    progressBySteps(steps: 5000, goal: 10000)
    progressBySteps(steps: 9000, goal: 10000)
    progressBySteps(steps: 10000, goal: 10000)
}
func progressBySteps(steps: Int, goal: Int) {
