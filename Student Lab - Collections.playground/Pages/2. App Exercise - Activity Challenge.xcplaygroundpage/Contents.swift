...
var walikngChallenge : [String] = ["Walk 5 times a day", "walk in the morning"]
...
var challenges : [[String]] = [walikngChallenge,runningChallenge]
...
if userCommittedChallenges.isEmpty {
    ...
    print("You have commited a challenge")
}
else{
